# Seworqs\Commons\Json\JsonEditor.php

## How to use JsonEditor?

1. **Make sure Seworqs\Commons is installed**
   ```php
...
2. **Create an instance of the JsonEditor**
   ...
   $jsonEditor = new Seworqs\Commons\Json\JsonEditor("path-to-file.json");
   ```
...
| Method                            | Description             |
| --------------------------------- | ----------------------- |
| [\_\_constructor](#__constructor) | The constructor.        |
...
The _\_\_constructor_ method will initialize the JsonEditor.
