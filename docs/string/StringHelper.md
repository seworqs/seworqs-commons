# Seworqs\Commons\String\StringHelper.php
...
1. **Make sure Seworqs\Commons is installed**
   ...
   ```
2. **Create an instance of the StringHelper**

   ```php
   // For example: the string helper.
   $scsh = new Seworqs\Commons\String\StringHelper();
   ```

3. **Use one of the available custom methods in the helper**
   ```php
